...
-   [CLehner](https://github.com/clehner) — [view contributions](https://github.com/bevry/staticsitegenerators/commits?author=clehner "View the GitHub contributions of CLehner on repository bevry/staticsitegenerators")
